...
reg [15:0] ofdm_in_i;
reg [15:0] ofdm_in_q;
wire ht_data_decoder_ready = (~pkt_ht) || (num_ofdm_symbol >= 16'd8);
    ...
    if (reset) begin
        ...
        case(state)
            ...
            S_DETECT_HT: begin
                ...
                ofdm_in_stb <= eq_out_stb_delayed && ht_data_decoder_ready;
            ...
            S_CHECK_HT_SIG: begin
                ...
                //     state <= S_HT_SIG_ERROR;
                    ...
                    if (num_ofdm_symbol == 5 || num_ofdm_symbol == 6) begin
                        state <= S_HT_STS;
                    end else begin
                        ht_next <= 1;
                        state <= S_HT_LTS;
